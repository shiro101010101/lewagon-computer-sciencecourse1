...
class Olist:
    ...
    def get_matching_table(self):
        ...
        # Creating a column to store the number of time a same product was ordered
        matching_table["number_of_products"] = 1
        

        # Counting the number of a same product ordered 
        # per granuarity customer x order x review x product x seller
